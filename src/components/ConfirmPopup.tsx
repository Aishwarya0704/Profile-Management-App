      ...
      <div className="bg-white p-5 rounded-md shadow-md">
        ...
        <div className="flex justify-end space-x-4 mt-10">
          <button
            ...
            className="px-2 py-1 bg-slate-300 text-sm text-gray-700 rounded hover:bg-gray-400"
          >
            Cancel
          </button>
          <button
            onClick={handleDelete}
            className="px-2 py-1 bg-blue-500 text-sm text-white rounded hover:bg-blue-700"
          >
            Confirm
          </button>
        </div>
